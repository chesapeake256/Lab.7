 ...
 * Conducts operations based on inputs from Main class
 */
...
public class RPSLSpock {
    ...
    /**
     * @author William Hopkins
     * @param pick player's pick
     * @return whether the "pick" input is a listed option
     */
    ...
    /**
     * @author William Hopkins
     * @return Computer's "pick" value from random number
     */
     ...
     * @param c_pick
     * @param h_pick
     * @return returns bool representing winner (computer or player)
     */
